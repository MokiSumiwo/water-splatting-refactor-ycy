...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_b01_noroute_capacity005_iui3_15000}" \
  STAMP="${STAMP:-20260728_b01_noroute_capacity005}" \
  ...
  LAMBDA_BUDGETED_CAPACITY="${LAMBDA_BUDGETED_CAPACITY:-0.0001}" \
