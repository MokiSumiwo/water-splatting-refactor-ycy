...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p12_b02_proxy_geom000_opacity050_capthr002_iui3_15000}" \
  STAMP="${STAMP:-20260729_p12_b02_proxy_geom000_opacity050_capthr002}" \
