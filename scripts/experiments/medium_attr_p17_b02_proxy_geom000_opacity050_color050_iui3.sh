...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p17_b02_proxy_geom000_opacity050_color050_iui3_15000}" \
  STAMP="${STAMP:-20260729_p17_b02_proxy_geom000_opacity050_color050}" \
  ...
  CLEAR_PROXY_COLOR_GRADIENT_SCALE="${CLEAR_PROXY_COLOR_GRADIENT_SCALE:-0.50}" \
