...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-bg_attr_c7_proxy_chroma01_iui3_resume10k_15000}" \
  STAMP="${STAMP:-20260727_c7_chroma01_resume10k}" \
  ...
  BG_CLEAR_CHROMA_WEIGHT="${BG_CLEAR_CHROMA_WEIGHT:-0.01}" \
