...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p8_b02_proxy_geom000_opacity050_chroma00125_iui3_15000}" \
  STAMP="${STAMP:-20260729_p8_b02_proxy_geom000_opacity050_chroma00125}" \
  ...
  BG_CLEAR_CHROMA_WEIGHT="${BG_CLEAR_CHROMA_WEIGHT:-0.00125}" \
