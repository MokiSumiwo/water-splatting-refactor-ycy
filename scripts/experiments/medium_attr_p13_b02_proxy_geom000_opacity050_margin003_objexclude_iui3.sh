...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p13_b02_proxy_geom000_opacity050_margin003_objexclude_iui3_15000}" \
  STAMP="${STAMP:-20260729_p13_b02_proxy_geom000_opacity050_margin003_objexclude}" \
