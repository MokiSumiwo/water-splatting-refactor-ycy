...
ACCUM_ZERO_WEIGHTS="${ACCUM_ZERO_WEIGHTS:-0 0.0005 0.001 0.002 0.004}"
...
for ACCUM_ZERO_WEIGHT_VALUE in ${ACCUM_ZERO_WEIGHTS}; do
  ...
  export EXPERIMENT_NAME="${EXPERIMENT_NAME_PREFIX:-m2_e2_accum}_${ACCUM_TAG}_${OWNERSHIP_MODE}_${MEDIUM_CONTEXT_MODE}_iui3_redsea_${MAX_NUM_ITERATIONS}"
  unset TIMESTAMP
