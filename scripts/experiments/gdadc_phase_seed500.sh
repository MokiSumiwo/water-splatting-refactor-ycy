...
export GPU="${GPU:-6}"
export EXPERIMENT_TAG="${EXPERIMENT_TAG:-gdadc_seed500_m1}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-gdadc_${EXPERIMENT_TAG}_${SCENE_SLUG}_seed${SEED:-42}_500}"
export MAX_NUM_ITERATIONS="${MAX_NUM_ITERATIONS:-500}"
export MODEL_NUM_STEPS="${MODEL_NUM_STEPS:-5000}"
export STEPS_PER_SAVE="${STEPS_PER_SAVE:-500}"
