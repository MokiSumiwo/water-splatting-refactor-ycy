...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-bg_attr_c6_proxy_chroma005_iui3_resume10k_15000}" \
  STAMP="${STAMP:-20260727_c6_chroma005_resume10k}" \
  ...
  BG_CLEAR_CHROMA_WEIGHT="${BG_CLEAR_CHROMA_WEIGHT:-0.005}" \
