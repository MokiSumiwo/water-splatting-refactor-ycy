...
GPU="${GPU:-0}"
SEED="${SEED:-42}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_DIR}/outputs/bnd_aa_panama_20260810}"
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-panama_bnd_aa_seed${SEED}_step0_to_${MAX_NUM_ITERATIONS}}"
TIMESTAMP="${TIMESTAMP:-20260810_bnd_aa}"
