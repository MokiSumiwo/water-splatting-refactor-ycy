...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-m4c_dc_balance0003_constrained_appearance_alpha_depth_dir_xy_camera_iui3_redsea_${MAX_NUM_ITERATIONS:-15000}}"
export DC_CHANNEL_BALANCE_WEIGHT="${DC_CHANNEL_BALANCE_WEIGHT:-0.0003}"
