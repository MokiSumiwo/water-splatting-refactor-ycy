...
export NEAR_ZERO_WEIGHT="${NEAR_ZERO_WEIGHT:-0.001}"
export LOSS_START_STEP="${LOSS_START_STEP:-1000}"
export LOSS_RAMP_STEPS="${LOSS_RAMP_STEPS:-3000}"

export EXPERIMENT_NAME="${EXPERIMENT_NAME:-m2_e4_tail_approx_${OWNERSHIP_MODE}_${MEDIUM_CONTEXT_MODE}_iui3_redsea_${MAX_NUM_ITERATIONS}}"
