...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p5_b02_proxy_geom000_opacity075_iui3_15000}" \
  STAMP="${STAMP:-20260729_p5_b02_proxy_geom000_opacity075}" \
  ...
  CLEAR_PROXY_OPACITY_GRADIENT_SCALE="${CLEAR_PROXY_OPACITY_GRADIENT_SCALE:-0.75}" \
