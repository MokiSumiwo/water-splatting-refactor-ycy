...
GPU="${GPU:-6}"
VARIANTS="${VARIANTS:-A0,A0_PHASE,A0_MHOLD,MHOLD}"
STEPS="${STEPS:-14000,15000}"
STAMP_BASE="${STAMP:-20260806_gmvc_v3_japanesegradens_p30_profile_release_13k_to_15k}"
ROOT="${ROOT:-${REPO_DIR}/renders/gmvc_fixed_bank_diag_20260806/japanesegradens_p30_profile_release_15k}"
LOAD_STEP_START="${LOAD_STEP_START:-13000}"
TARGET_FINAL_STEP="${TARGET_FINAL_STEP:-15000}"
SAVE_RGB_RENDERS="${SAVE_RGB_RENDERS:-0}"
RUN_SUMMARY="${RUN_SUMMARY:-1}"

EVALF_BANK="${EVALF_BANK:-${REPO_DIR}/renders/gmvc_v3_geometry_track_banks/japanesegradens_redsea_m1_step10000_train_s4096_seed123/gmvc_track_bank.pt}"
EVALG_BANK="${EVALG_BANK:-${REPO_DIR}/renders/gmvc_v3_geometry_track_banks/japanesegradens_redsea_m1_step10000_train_s4096/gmvc_track_bank.pt}"

variant_slug() {
  case "$1" in
    A0|a0) echo "a0" ;;
    A0_MHOLD|a0_mhold|A0-MHOLD|a0-mhold) echo "a0_mhold" ;;
    A0_PHASE|a0_phase|A0-PHASE|a0-phase) echo "a0_phase" ;;
    MHOLD|mhold|P30_MHOLD|p30_mhold|P30-MHOLD|p30-mhold) echo "mhold" ;;
...
experiment_name() {
  local slug="$1"
  echo "gmvc_v3_japanesegradens_p30_release_${slug}_seed42_step${LOAD_STEP_START}_to_${TARGET_FINAL_STEP}"
}
