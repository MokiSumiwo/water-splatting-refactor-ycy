...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-m2_e3_delay${LOSS_START_STEP}_ramp${LOSS_RAMP_STEPS}_${OWNERSHIP_MODE}_${MEDIUM_CONTEXT_MODE}_iui3_redsea_${MAX_NUM_ITERATIONS}}"
