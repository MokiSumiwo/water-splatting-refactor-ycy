...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-mpdr_g4_best_combo_japanesegradens_5k}"
...
export MPDR_DETAIL_SCORE_WEIGHT="${MPDR_DETAIL_SCORE_WEIGHT:-0.25}"
export SH_CURRICULUM_ENABLED="True"
