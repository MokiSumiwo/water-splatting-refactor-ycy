...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p2_b02_proxy_geom050_opacity050_iui3_15000}" \
  STAMP="${STAMP:-20260729_p2_b02_proxy_geom050_opacity050}" \
  ...
  CLEAR_PROXY_GEOMETRY_GRADIENT_SCALE="${CLEAR_PROXY_GEOMETRY_GRADIENT_SCALE:-0.50}" \
