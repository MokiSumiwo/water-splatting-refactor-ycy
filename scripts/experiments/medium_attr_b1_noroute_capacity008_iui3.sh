...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_b1_noroute_capacity008_iui3_15000}" \
  STAMP="${STAMP:-20260728_b1_noroute_capacity008}" \
  ...
  BUDGETED_CAPACITY_VALUE="${BUDGETED_CAPACITY_VALUE:-0.08}" \
