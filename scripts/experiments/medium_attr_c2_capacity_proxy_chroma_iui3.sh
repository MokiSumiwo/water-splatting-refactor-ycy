...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_c2_capacity_proxy_chroma_iui3_15000}" \
  STAMP="${STAMP:-20260728_c2_capacity_proxy_chroma}" \
  ...
  LAMBDA_BUDGETED_CAPACITY="${LAMBDA_BUDGETED_CAPACITY:-0.001}" \
