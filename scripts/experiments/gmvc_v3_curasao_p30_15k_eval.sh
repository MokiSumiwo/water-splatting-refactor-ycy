...
GPU="${GPU:-6}"
VARIANTS="${VARIANTS:-A0,P30}"
STEPS="${STEPS:-14000,15000}"
STAMP="${STAMP:-20260805_gmvc_v3_curasao_p30_13k_to_15k}"
ROOT="${ROOT:-${REPO_DIR}/renders/gmvc_fixed_bank_diag_20260805/curasao_p30_15k}"
...
experiment_name() {
  local slug="$1"
  if [[ "${slug}" == "a0" ]]; then
    echo "gmvc_v3_a0_15k_curasao_seed42_step${LOAD_STEP_START}_to_${TARGET_FINAL_STEP}"
  else
    echo "gmvc_v3_r500_p30_15k_curasao_seed42_step${LOAD_STEP_START}_to_${TARGET_FINAL_STEP}"
  fi
}
