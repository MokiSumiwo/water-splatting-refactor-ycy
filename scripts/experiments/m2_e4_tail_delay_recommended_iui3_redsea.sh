...
export INFINITE_WATER_COMPOSE_MODE="tail_approx"
...
export LOSS_START_STEP="${LOSS_START_STEP:-5000}"
export LOSS_RAMP_STEPS="${LOSS_RAMP_STEPS:-5000}"

export EXPERIMENT_NAME="${EXPERIMENT_NAME:-m2_e4_tail_delay_recommended_${OWNERSHIP_MODE}_${MEDIUM_CONTEXT_MODE}_iui3_redsea_${MAX_NUM_ITERATIONS}}"
