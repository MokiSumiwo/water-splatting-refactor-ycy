...
case "${VARIANT}" in
  ...
  A0_MHOLD|a0_mhold|A0-MHOLD|a0-mhold)
    ...
    ;;
  A0_PHASE|a0_phase|A0-PHASE|a0-phase|A0_STOP|a0_stop|A0-STOP|a0-stop)
    SLUG="a0_phase"
    SOURCE_CKPT="${A0_SOURCE_CKPT}"
    GMVC_ON="True"
    PROFILE_SCHEDULE="stop"
  ...
  H500|h500|H500_STOP|h500_stop)
    ...
    PROFILE_LAMBDA="30"
    OBJECT_LAMBDA="0.004"
    PROFILE_DECAY_START_STEP="13501"
    DEFAULT_STEPS_PER_SAVE="500"
    ;;
  MHOLD|mhold|P30_MHOLD|p30_mhold)
    SLUG="mhold"
    SOURCE_CKPT="${P30_SOURCE_CKPT}"
    GMVC_ON="True"
    PROFILE_SCHEDULE="stop"
  ...
  DECAY|decay)
    ...
    ;;
  *)
    echo "Unknown VARIANT=${VARIANT}. Use A0, A0_MHOLD, A0_PHASE, C30, STOP, H500, MHOLD, or DECAY." >&2
    exit 2
    ;;
esac
...
exec env \
  ...
  GMVC_GRAD_LOG_FORCE_STEPS="${GMVC_GRAD_LOG_FORCE_STEPS:-13001,13004,13500,13501,14000,15000}" \
