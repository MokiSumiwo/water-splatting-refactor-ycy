...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p1_b02_proxy_geom025_opacity025_iui3_15000}" \
  STAMP="${STAMP:-20260729_p1_b02_proxy_geom025_opacity025}" \
  ...
  CLEAR_PROXY_GEOMETRY_GRADIENT_SCALE="${CLEAR_PROXY_GEOMETRY_GRADIENT_SCALE:-0.25}" \
  CLEAR_PROXY_OPACITY_GRADIENT_SCALE="${CLEAR_PROXY_OPACITY_GRADIENT_SCALE:-0.25}" \
