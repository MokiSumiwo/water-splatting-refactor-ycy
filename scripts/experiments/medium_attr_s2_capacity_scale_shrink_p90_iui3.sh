...
exec env \
  GPU="${GPU:-9}" \
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_s2_capacity_scale_shrink_p90_iui3_15000}" \
  STAMP="${STAMP:-20260729_s2_capacity_scale_shrink_p90}" \
  ...
  CAPACITY_CONTROL_SCALE_SHRINK_CLIP_QUANTILE="0.90" \
