...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p15_b02_proxy_geom000_opacity050_objexclude_iui3_15000}" \
  STAMP="${STAMP:-20260729_p15_b02_proxy_geom000_opacity050_objexclude}" \
