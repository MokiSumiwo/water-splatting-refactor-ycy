...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-bg_attr_c2_proxy_chroma0001_iui3_resume10k_15000}" \
  STAMP="${STAMP:-20260727_c2_chroma0001_resume10k}" \
  ...
  BG_CLEAR_CHROMA_WEIGHT="${BG_CLEAR_CHROMA_WEIGHT:-0.0001}" \
