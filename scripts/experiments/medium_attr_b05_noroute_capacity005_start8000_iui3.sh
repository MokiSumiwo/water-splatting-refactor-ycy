...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_b05_noroute_capacity005_start8000_iui3_15000}" \
  STAMP="${STAMP:-20260728_b05_noroute_capacity005_start8000}" \
  ...
  BUDGETED_CAPACITY_START_STEP="${BUDGETED_CAPACITY_START_STEP:-8000}" \
  ...
  LAMBDA_BUDGETED_CAPACITY="${LAMBDA_BUDGETED_CAPACITY:-0.0005}" \
