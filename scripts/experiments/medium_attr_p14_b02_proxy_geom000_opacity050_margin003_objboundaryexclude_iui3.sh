...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p14_b02_proxy_geom000_opacity050_margin003_objboundaryexclude_iui3_15000}" \
  STAMP="${STAMP:-20260729_p14_b02_proxy_geom000_opacity050_margin003_objboundaryexclude}" \
