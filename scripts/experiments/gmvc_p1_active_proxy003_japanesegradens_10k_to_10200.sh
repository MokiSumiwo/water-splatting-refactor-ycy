...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-gmvc_p1_active_proxy003_japanesegradens_redsea_seed42_step10000_to_10200}"
STAMP="${STAMP:-20260803_gmvc_p1_active_proxy003_short}"
...
exec env \
  ...
  GMVC_VARIANT="p1_active_proxy003" \
  GMVC_NEEDS_BANK="1" \
  GMVC_ENABLED="True" \
  ...
  LAMBDA_GMVC_INTRINSIC="${LAMBDA_GMVC_INTRINSIC:-0.03}" \
