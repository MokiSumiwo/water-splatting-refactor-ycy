...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_c1_b02_capacity_proxy_chroma001_iui3_15000}" \
  STAMP="${STAMP:-20260728_c1_b02_capacity_proxy_chroma001}" \
  ...
  BG_CLEAR_CHROMA_WEIGHT="${BG_CLEAR_CHROMA_WEIGHT:-0.001}" \
