...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_q1_capacity_opacity_only_iui3_15000}" \
  STAMP="${STAMP:-20260729_q1_capacity_opacity_only}" \
  ...
  CAPACITY_CONTROL_GEOMETRY_GRADIENT_SCALE="${CAPACITY_CONTROL_GEOMETRY_GRADIENT_SCALE:-0.0}" \
