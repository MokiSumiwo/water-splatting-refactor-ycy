...
exec env \
  GPU="${GPU:-7}" \
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_p20_b02_proxy_geom000_opacity050_chroma_objboundaryexclude_iui3_15000}" \
  STAMP="${STAMP:-20260729_p20_b02_proxy_geom000_opacity050_chroma_objboundaryexclude}" \
  ...
  MEDIUM_SUPPORT_EXCLUDE_BOUNDARY="True" \
