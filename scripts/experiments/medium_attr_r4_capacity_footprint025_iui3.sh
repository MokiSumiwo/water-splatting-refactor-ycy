...
exec env \
  GPU="${GPU:-7}" \
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-medium_attr_r4_capacity_footprint025_iui3_15000}" \
  STAMP="${STAMP:-20260729_r4_capacity_footprint025}" \
  ...
  CAPACITY_CONTROL_FOOTPRINT_GRADIENT_SCALE="0.25" \
