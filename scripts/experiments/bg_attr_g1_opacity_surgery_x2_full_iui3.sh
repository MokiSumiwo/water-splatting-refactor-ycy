...
exec env \
  ...
  EXPERIMENT_NAME="${EXPERIMENT_NAME:-bg_attr_g1_c5_opacity_surgery_x2_iui3_full_s10001_15000}" \
  STAMP="${STAMP:-20260727_g1_c5_opacity_x2_full_s10001}" \
  ...
  BACKGROUND_CLEAR_CHROMA_START_STEP="${BACKGROUND_CLEAR_CHROMA_START_STEP:-10001}" \
  ...
  BACKGROUND_OPACITY_DECREASE_MULTIPLIER="${BACKGROUND_OPACITY_DECREASE_MULTIPLIER:-2.0}" \
  BACKGROUND_OPACITY_INCREASE_MULTIPLIER="${BACKGROUND_OPACITY_INCREASE_MULTIPLIER:-1.0}" \
  BACKGROUND_GRADIENT_SURGERY_START_STEP="${BACKGROUND_GRADIENT_SURGERY_START_STEP:-10001}" \
