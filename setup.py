...
__version__ = None
exec(open("water_splatting/version.py", "r").read())
...
def get_extensions():
    ...
    extensions_dir = osp.join("water_splatting", "cuda", "csrc")
    ...
    if sys.platform == "win32":
        define_macros += [("water_splatting_EXPORTS", None)]
